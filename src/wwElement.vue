...
:global(html.dark) .spread-kd__kpi-val { color: #e6d8ca; }
...
:global(html.dark) .spread-kd__section-title { color: #e6d8ca; }
:global(html.dark) .spread-kd__divider { border-color: rgba(230,216,202,0.08); }
:global(html.dark) .spread-kd select,
:global(html.dark) .spread-kd input { background: #160c11; border-color: rgba(230,216,202,0.2); color: #e6d8ca; }
</style>
